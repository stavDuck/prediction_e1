package user.subcomponents.tabs.results;
...
import user.subcomponents.tabs.results.histogram.average.AverageValueComponentController;
import user.subcomponents.tabs.results.histogram.consistency.ConsistencyComponentController;
import user.subcomponents.tabs.results.histogram.entities.EntitiesHistogramComponentController;
import user.subcomponents.tabs.results.logic.task.TaskSimulationPause;
import user.subcomponents.tabs.results.logic.task.TaskSimulationResume;
import user.subcomponents.tabs.results.logic.task.TaskSimulationRunningDetails;
import user.subcomponents.tabs.results.logic.task.TaskSimulationStop;
