package user.subcomponents.tabs.details;
...
import user.subcomponents.actions.Calculation.CalculateComponentController;
import user.subcomponents.actions.Condition.multiple.MultipleConditionComponentController;
import user.subcomponents.actions.Condition.single.SingleConditionComponentController;
import user.subcomponents.actions.Decrease.DecreaseComponentController;
import user.subcomponents.actions.Increase.IncreaseComponentController;
import user.subcomponents.actions.Kill.KillCompenentController;
import user.subcomponents.actions.Proximity.ProximityComponentController;
